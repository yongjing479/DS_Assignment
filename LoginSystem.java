    ...
    public boolean login() {
        ...
        for (User account : login_info) {
            if (account.getUsername().equals(username) && account.getPassword().equals(password)) {
                ...
                return true;
            } else if (account.getEmail().equals(username) && account.getPassword().equals(password)) {
                System.out.println("Login successful.");
                loggedIn = true;
                currentUser = account;
                currentUserId = account.getId();
                return true;
            } else if (account.getPhoneNumber().equals(username) && account.getPassword().equals(password)) {
                System.out.println("Login successful.");
                loggedIn = true;
                currentUser = account;
                currentUserId = account.getId();
